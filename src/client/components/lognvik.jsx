...
import Lognvik1 from "../img/lognvikgard_1.jpeg";
            ...
            <div className="content2 lognvik">
                <div className="paragraf">
                    ...
                    <div className="text">
                        ...
                        <p>Lognvik Søndre Gård er familien til Magnus sin gård i Rauland i Telemark fra 16- og 17-hundretallet. Gården ble opprinnelig kjøpt av Magnus sin oldefar Harald Didrik Kongshem i år 1933. Etter dette var det Magnus sin farfar, Torstein Halvor Kongshem, som overtok etter sin far. I dag er det faren til Magnus, Torstein Didrik Kongshem som eier og driver gården.
                        </p>
                        <p>
                            Lognvik betyr "den lugne viken" og har i hele Magnus sitt liv vært hans kjæreste ferie-paradis. Så fort annledningen har bydd seg har Magnus hatt et ønske om å tilbringe tid på denne fantastiske plassen. Det har vært veldig viktig for Magnus å dele denne plassen med sine nærmeste, så hver sommer de siste 10 årene har det vært en årlig vennetur til Lognvik.
                        </p>
                        <p>
                            Kathrine ble tidlig introdusert for Lognvik og tilbragte sin første påskeferie sammen med Magnus på Lognvik. Med årene har Kathrine og Magnus brukt mye av ferien sin her oppe, da det tilbyr veldig fine turmuligheter både med og uten ski for dem alle 3.
                        </p>
                        <p>
