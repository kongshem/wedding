  ...
  render(){
    return(
      <div className="content2 practicalInfo">
        ...
        <p>Når du ankommer Lognvik kan du dra til Fjellstua for å motta nøkkel og informasjon om hvor du skal bo. Når du har installert deg er det grilling ved Fjellstua. Ta med det du vil grille og drikke, vi stiller med grill og tilbehør. Vi starter grillingen kl 18. Dersom været ikke er på vår side vil grillingen foregå inne på fjellstua.</p>
